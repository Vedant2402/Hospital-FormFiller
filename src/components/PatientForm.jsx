...
const PatientForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetchSubmitForm(formData);
      if (response) {
        sessionStorage.setItem("narretive_text", response.narrative || "");
        navigate("/confirmation");
      } else {
      ...
      <form onSubmit={handleSubmit} className="space-y-8 lg:space-y-10">
        ...
        <div className="bg-gray-50 rounded-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <div>
              <label htmlFor="healthPlan" className="form-label">
                Health Plan
              </label>
              <input
                id="healthPlan"
            ...
            <div>
              <label htmlFor="healthPlanFax" className="form-label">
                Health Plan Fax #
              </label>
              <input
                id="healthPlanFax"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() =>
                    listeningField === "name" ? stopVoice() : startVoice("name")
                  }
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() =>
                    listeningField === "age" ? stopVoice() : startVoice("age")
                  }
                  className={`absolute right-3 top-1/2 -translate-y-1/2 p-1.5 rounded-md ${
                    listeningField === "age"
                      ? "text-red-600 bg-red-50 animate-pulse"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className={`form-input pl-10 pr-12 resize-none ${
        ...
        <div className="bg-gray-50 rounded-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <div>
              <label htmlFor="requestingProviderNameNPI" className="form-label">
                Requesting Provider Name and NPI
              </label>
              <input
                id="requestingProviderNameNPI"
                name="requestingProviderNameNPI"
                type="text"
                value={formData.requestingProviderNameNPI}
                onChange={handleInputChange}
                className="form-input"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="requestingProviderPhone" className="form-label">
                  Phone
                </label>
                <input
                  id="requestingProviderPhone"
                  name="requestingProviderPhone"
                  type="tel"
                  value={formData.requestingProviderPhone}
                  onChange={handleInputChange}
                  className="form-input"
                  placeholder="(###) ###-####"
                />
              ...
              <div>
                <label htmlFor="requestingProviderFax" className="form-label">
                  Fax
                </label>
                <input
                  id="requestingProviderFax"
                  name="requestingProviderFax"
                  type="text"
                  value={formData.requestingProviderFax}
                  onChange={handleInputChange}
                  className="form-input"
                  placeholder="(###) ###-####"
                />
            ...
            <div>
              <label
                htmlFor="servicingProviderNameNPITaxId"
                className="form-label"
              >
                Servicing Provider Name and NPI (and Tax ID if required)
              </label>
              <input
                id="servicingProviderNameNPITaxId"
                name="servicingProviderNameNPITaxId"
                type="text"
                value={formData.servicingProviderNameNPITaxId}
                onChange={handleInputChange}
                className="form-input"
                placeholder="Name, NPI, Tax ID"
              />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="servicingProviderPhone" className="form-label">
                  Phone
                </label>
                <input
                  id="servicingProviderPhone"
                  name="servicingProviderPhone"
                  type="tel"
                  value={formData.servicingProviderPhone}
                  onChange={handleInputChange}
                  className="form-input"
                  placeholder="(###) ###-####"
                />
              ...
              <div>
                <label htmlFor="servicingProviderFax" className="form-label">
                  Fax
                </label>
                <input
                  id="servicingProviderFax"
                  name="servicingProviderFax"
                  type="text"
                  value={formData.servicingProviderFax}
                  onChange={handleInputChange}
                  className="form-input"
                  placeholder="(###) ###-####"
                />
            ...
            <div className="md:col-span-2 lg:col-span-3 flex items-center space-x-3">
              <input
                id="sameAsRequestingProvider"
                name="sameAsRequestingProvider"
                type="checkbox"
                className="form-checkbox"
                checked={formData.sameAsRequestingProvider}
                onChange={handleCheckboxChange}
              />
              <label
                htmlFor="sameAsRequestingProvider"
                className="text-sm text-gray-700"
              >
                Servicing Provider same as Requesting Provider
              </label>
            </div>

            <div>
              <label htmlFor="servicingFacilityNameNPI" className="form-label">
                Servicing Facility Name and NPI
              </label>
              <input
                id="servicingFacilityNameNPI"
                name="servicingFacilityNameNPI"
                type="text"
                value={formData.servicingFacilityNameNPI}
                onChange={handleInputChange}
                className="form-input"
                placeholder="Facility Name, NPI"
              />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="servicingFacilityPhone" className="form-label">
                  Phone
                </label>
                <input
                  id="servicingFacilityPhone"
                  name="servicingFacilityPhone"
                  type="tel"
                  value={formData.servicingFacilityPhone}
                  onChange={handleInputChange}
                  className="form-input"
                  placeholder="(###) ###-####"
                />
              ...
              <div>
                <label htmlFor="servicingFacilityFax" className="form-label">
                  Fax
                </label>
                <input
                  id="servicingFacilityFax"
                  name="servicingFacilityFax"
                  type="text"
                  value={formData.servicingFacilityFax}
                  onChange={handleInputChange}
                  className="form-input"
                  placeholder="(###) ###-####"
                />
            ...
            <div className="md:col-span-2 lg:col-span-3 flex items-center space-x-3">
              <input
                id="sameAsRequestingProviderFacility"
                name="sameAsRequestingProviderFacility"
                type="checkbox"
                className="form-checkbox"
                checked={formData.sameAsRequestingProviderFacility}
                onChange={handleCheckboxChange}
              />
              <label
                htmlFor="sameAsRequestingProviderFacility"
                className="text-sm text-gray-700"
              >
                Servicing Facility same as Requesting Provider
              </label>
            </div>
        ...
        <div className="bg-gray-50 rounded-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <div>
              <label htmlFor="healthInsuranceId" className="form-label">
                Health Insurance ID#
              </label>
              <input
            ...
            <div>
              <label htmlFor="patientAccountNumber" className="form-label">
            ...
            <div>
              <label htmlFor="otherInsurance" className="form-label">
                If other insurance, please specify
              </label>
              <input
                id="otherInsurance"
                name="otherInsurance"
                ...
                onChange={handleInputChange}
                className="form-input"
                placeholder="Other insurance provider"
              />
            </div>
            <div>
              <label htmlFor="memberAddress" className="form-label">
                Member Address (defaults to Address)
              </label>
              <input
                id="memberAddress"
                name="memberAddress"
        ...
        <div className="bg-gray-50 rounded-xl p-6 lg:p-8 border border-gray-100">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-2">
              Include any allergies, current medications, chronic conditions, or
              previous surgeries.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <label
                htmlFor="principalDiagnosisDescription"
                className="form-label"
              >
                Principal Diagnosis Description
              </label>
              <input
                id="principalDiagnosisDescription"
                name="principalDiagnosisDescription"
                type="text"
                value={formData.principalDiagnosisDescription}
                onChange={handleInputChange}
                className="form-input"
              />
            </div>
            <div>
              <label htmlFor="principalDiagnosisICD10" className="form-label">
                ICD-10 Codes
              </label>
              <input
                id="principalDiagnosisICD10"
                name="principalDiagnosisICD10"
                type="text"
                value={formData.principalDiagnosisICD10}
                onChange={handleInputChange}
                className="form-input"
            ...
            <div>
              <label
                htmlFor="secondaryDiagnosisDescription"
                className="form-label"
              >
                Secondary Diagnosis Description
              </label>
              <input
                id="secondaryDiagnosisDescription"
            ...
            <div>
              <label htmlFor="secondaryDiagnosisICD10" className="form-label">
                ICD-10 Codes
              </label>
              <input
                id="secondaryDiagnosisICD10"
                name="secondaryDiagnosisICD10"
                type="text"
                value={formData.secondaryDiagnosisICD10}
                onChange={handleInputChange}
                className="form-input"
              />
            </div>
            ...
            <div className="md:col-span-2 grid md:grid-cols-2 gap-6">
              <div>
                <label
                  htmlFor="principalPlannedProcedureDescriptionCPT"
                  className="form-label"
                >
                  Principal Planned Procedure (Description and CPT/HCPCS Code)
                </label>
                <input
                  id="principalPlannedProcedureDescriptionCPT"
                  name="principalPlannedProcedureDescriptionCPT"
                  type="text"
                  value={formData.principalPlannedProcedureDescriptionCPT}
                  onChange={handleInputChange}
                  className="form-input"
                  placeholder="Description, CPT/HCPCS"
                />
              </div>
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <input
                    name="principalUnitsNumber"
                    type="number"
                    value={formData.principalUnitsNumber}
                    onChange={handleInputChange}
                    className="form-input"
                    placeholder="#"
                  />
                  <select
                    name="principalUnitsType"
                    value={formData.principalUnitsType}
                    onChange={handleInputChange}
                    className="form-input"
                  >
            ...
            <div className="md:col-span-2 grid md:grid-cols-2 gap-6">
              <div>
                <label
                  htmlFor="secondaryPlannedProcedureDescriptionCPT"
                  className="form-label"
                >
                  Secondary Planned Procedure (Description and CPT/HCPCS Code)
                </label>
                <input
                  id="secondaryPlannedProcedureDescriptionCPT"
                  name="secondaryPlannedProcedureDescriptionCPT"
                  type="text"
                  value={formData.secondaryPlannedProcedureDescriptionCPT}
                  onChange={handleInputChange}
                  className="form-input"
                  placeholder="Description, CPT/HCPCS"
                />
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <input
                    name="secondaryUnitsNumber"
                    type="number"
                    value={formData.secondaryUnitsNumber}
                    onChange={handleInputChange}
                    className="form-input"
                    placeholder="#"
                  />
                  <select
                    ...
                    value={formData.secondaryUnitsType}
                    onChange={handleInputChange}
                    className="form-input"
                  >
                    <option value="">Select</option>
